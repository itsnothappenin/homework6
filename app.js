...
if (userChoice == "Show coin list") {
    ...
    await inquirer.prompt([{
        ...
        message: chalk.cyan('Choose of the coins'),
    ...
    console.log(chalk.green.bold(date + '.json file has been created successfully!'));
    ...
    app.listen(3000, ()=> {
        console.log(chalk.green(`Server running at http://localhost:3000/coins/all\nCheck http://localhost:3000/market-chart/{${chalk.red('coin-name')}}`));
    })
}
